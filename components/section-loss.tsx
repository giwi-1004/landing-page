  ...
  return (
    <section id="loss" className="landing-section landing-section-mint">
      <div className="landing-banner mb-10">
        <p className="text-base font-bold text-navy">나중에 하셔도 됩니다</p>
      ...
      <div className="mb-10 grid grid-cols-2 gap-4">
        {LOSS_CARDS.map((card) => (
          <div key={card.line1} className="landing-card py-7 text-center">
            <p className="mb-2 text-xs text-navy/70">{card.line1}</p>
            <p className="text-sm font-bold text-navy">{card.line2}</p>
          </div>
        ))}
      </div>
